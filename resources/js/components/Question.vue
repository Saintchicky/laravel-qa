...
export default {
    ...
    data(){
        return {
            ...
            id: this.question.id,
            // retiens la question avant de la modifier. 
            // C'est un objet vide ds lequel on mettra le titre et le body
            beforeEditCache:{}
        }
    },
    computed:{
    ...
    methods:{
        ...
        payload(){
            return {
                // remplace le local body et title qui vient de la réponse ajax
                body : this.body,
                title : this.title
            };         
        },
        delete(){
            axios.delete(this.endpoint)
                ...
                setTimeout(()=>{
                    // redirection après validation et d'un timeout
